 ...
 */
class DrawAbleSprite : public Renderable {
private:
  bool mIsOff;
...
public:
   ...
   */
  DrawAbleSprite()
      : Renderable(Color(255, 255, 255, 255),
                   [&](Renderable *component, SDL_Renderer *renderer) {
                     mIsOff = !move();
                     SDL_SetRenderDrawColor(renderer, mColor.r, mColor.g,
                                            mColor.b, mColor.a);
                     SDL_Rect rect = createRect(mX, mY, mWidth, mHeight);
                     SDL_RenderFillRect(renderer, &rect);
                     SDL_SetRenderDrawColor(renderer, mOutline.r, mOutline.g,
                                            mOutline.b, mOutline.a);
